...
Conditional expressions are limited to a single ternary operator and the logical operators. Values rendered by nested ternary operators will not be recognised.
