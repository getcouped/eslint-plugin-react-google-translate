...
module.exports = {
  ...
  create(context) {
    ...
    return {
      ...
      // or `toString`
      Identifier(node) {
        if (parserServices) return; // this will be reported by CallExpression
        if (
